...
Our mixed effects model controled for state and year grouping (with random intercepts) as well as included a random slope for unemployment. The anova table of the resulting model (though limited due to data contraints) showed that unemployment is indeed likely significant. 
